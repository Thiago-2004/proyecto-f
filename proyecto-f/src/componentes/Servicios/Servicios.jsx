...
function Servicios() {
    return (
      <div>
        ...
        <div className="card-group mt-5">
          <div className="card">
            <img src="https://th.bing.com/th/id/OIP.N4FuuTUioNlCPKo5PagcVAHaEH?w=261&h=180&c=7&r=0&o=5&dpr=1.7&pid=1.7" className="card-img-top" alt="Fumigación Avanzada" />
            <div className="card-body">
              <h5 className="card-title">FUMIGACION AVANZADA</h5>
              <p className="card-text">
                Proporcionamos servicios de fumigación avanzada para una amplia variedad de plagas, utilizando productos de última generación que son seguros para el medio ambiente y para los humanos.
                Nuestros especialistas están entrenados para identificar las plagas y aplicar las técnicas más efectivas para su eliminación.
              </p>
              <p className="card-text">
                <small className="text-body-secondary">Servicio disponible 24/7</small>
              </p>
            </div>
          </div>
  
          <div className="card">
            <img src='https://th.bing.com/th/id/OIP.T23PBsGMRDE23Y4-DxBuGgHaE8?w=256&h=180&c=7&r=0&o=5&dpr=1.7&pid=1.7' className="card-img-top" alt="Asesoría Ambiental" />
            <div className="card-body">
              <h5 className="card-title">ASESORIA AMBIENTAL</h5>
              <p className="card-text">
                Ofrecemos asesoría completa en temas ambientales, incluyendo el manejo de residuos, la reducción de huella ecológica y la implementación de prácticas sostenibles.
                Nuestros servicios están diseñados para empresas y particulares que desean minimizar su impacto ambiental y cumplir con las normativas vigentes.
              </p>
              <p className="card-text">
                <small className="text-body-secondary"></small>
              </p>
